...
def render():
    ...
    screen.blit(big_logo_sprite.image, big_logo_sprite.rect)
    screen.blit(new_game_button_sprite.image, new_game_button_sprite.rect)
    screen.blit(load_button_sprite.image, load_button_sprite.rect)
    screen.blit(settings_button_sprite.image, settings_button_sprite.rect)
...
screen_buttons = (Functions.Button(exit_button_sprite.rect, 'exit', exit_event),
                  Functions.Button(settings_button_sprite.rect, 'settings', open_settings),
                  Functions.Button(load_button_sprite.rect, 'load', open_load_screen),
                  Functions.Button(new_game_button_sprite.rect, 'new game', open_new_game_screen))
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
##################
